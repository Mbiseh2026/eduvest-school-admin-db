...
export const PARENTS: Parent[] = [
  ...
  { id: "p8", name: "Kojo Mensah", phone: "+233 244 99 11 04", email: "kojo@example.com", workspace: "High School", level: "Lower Sixth", children: ["Leo Mensah"], lastMessage: "Term invoice — 3 days ago" },
  ...
  { id: "p11", name: "Jeanne Atangana", phone: "+237 690 33 44 15", email: "jeanne@example.com", workspace: "High School", level: "Terminale", children: ["Sophie Atangana"], lastMessage: "Examen blanc — vendredi" },
  { id: "p12", name: "Marthe Mbarga", phone: "+237 690 33 44 16", email: "marthe@example.com", workspace: "Prenursery", level: "Crèche", children: ["Thierry Mbarga"], lastMessage: "Photo day — today" },
];
